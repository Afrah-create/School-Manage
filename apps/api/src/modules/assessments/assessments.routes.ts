...
assessmentsRouter.post("/cbc", requireAssessmentRoles("subject_teacher"), asyncHandler(c.postCbc));
assessmentsRouter.post("/cbc/bulk", requireAssessmentRoles("subject_teacher"), asyncHandler(c.postCbcBulk));
assessmentsRouter.post("/cbc/submit", requireAssessmentRoles("subject_teacher"), asyncHandler(c.submitCbc));
assessmentsRouter.patch("/cbc/unlock", requireAssessmentRoles("headteacher"), asyncHandler(c.unlockCbc));
assessmentsRouter.get("/cbc/project", requireAssessmentRoles("subject_teacher", "admin"), asyncHandler(c.getCbcProject));
assessmentsRouter.post("/cbc/project", requireAssessmentRoles("subject_teacher"), asyncHandler(c.postCbcProject));
assessmentsRouter.put("/cbc/project/:id", requireAssessmentRoles("subject_teacher"), asyncHandler(c.putCbcProject));
assessmentsRouter.get(
  "/cbc/comments",
...
assessmentsRouter.get(
  "/alevel",
  requireAssessmentRoles("subject_teacher", "admin", "headteacher"),
  asyncHandler(c.getAlevel),
);
assessmentsRouter.post("/alevel", requireAssessmentRoles("subject_teacher"), asyncHandler(c.postAlevel));
assessmentsRouter.post("/alevel/bulk", requireAssessmentRoles("subject_teacher"), asyncHandler(c.postAlevelBulk));
assessmentsRouter.post("/alevel/submit", requireAssessmentRoles("subject_teacher"), asyncHandler(c.submitAlevel));
assessmentsRouter.get(
  "/alevel/division",
  requireAssessmentRoles("subject_teacher", "admin", "headteacher"),
...
assessmentsRouter.get(
  "/subjects-assigned",
  requireAssessmentRoles("subject_teacher"),
