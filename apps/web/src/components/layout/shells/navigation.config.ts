    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { href: "/admin/exams", label: "Formal exams", icon: "fileText", activePrefix: "/admin/exams" },
        ],
      },
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { href: "/headteacher/exams", label: "Formal exams", icon: "fileText", activePrefix: "/headteacher/exams" },
        ],
      },
      {
