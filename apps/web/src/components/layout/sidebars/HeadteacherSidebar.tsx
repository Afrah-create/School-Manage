...
const ITEMS: { href: string; label: string; activePrefix?: string }[] = [
  { href: "/headteacher/dashboard", label: "Dashboard" },
  {
  ...
  { href: "/headteacher/reports", label: "Report Cards", activePrefix: "/headteacher/reports" },
  { href: "/headteacher/analytics", label: "Analytics", activePrefix: "/headteacher/analytics" },
];
  ...
  return (
    <aside className="flex h-full w-56 shrink-0 flex-col border-r border-slate-200 bg-white">
      <div className="border-b border-slate-200 px-4 py-4">
        <div className="text-lg font-bold text-brand">Headteacher</div>
